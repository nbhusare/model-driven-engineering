...
public class EntitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EntityPackage.PACKAGE: {
				com.gyaltso.ecore.model.entity.Package package_ = (com.gyaltso.ecore.model.entity.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = caseNamedElement(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntityPackage.DATA_TYPE: {
			...
			case EntityPackage.CONCRETE_ENTITY: {
				ConcreteEntity concreteEntity = (ConcreteEntity)theEObject;
				T result = caseConcreteEntity(concreteEntity);
				if (result == null) result = caseEntity(concreteEntity);
				if (result == null) result = caseDataType(concreteEntity);
				if (result == null) result = caseNamedElement(concreteEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntityPackage.ENUMERATION: {
	 ...
	 * @generated
	 */
	public T casePackage(com.gyaltso.ecore.model.entity.Package object) {
		return null;
	}
