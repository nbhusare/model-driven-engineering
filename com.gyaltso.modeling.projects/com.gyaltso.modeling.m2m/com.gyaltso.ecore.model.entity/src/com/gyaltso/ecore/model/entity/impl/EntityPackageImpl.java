...
public class EntityPackageImpl extends EPackageImpl implements EntityPackage {
	 ...
	 * @see com.gyaltso.ecore.model.entity.EntityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getConcreteEntity_Abstract() {
		return (EAttribute)concreteEntityEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getConcreteEntity_SuperEntity() {
		return (EReference)concreteEntityEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getConcreteEntity_Attributes() {
		return (EReference)concreteEntityEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getAttribute_Volatile() {
	...
	public void createPackageContents() {
		...
		createEAttribute(concreteEntityEClass, CONCRETE_ENTITY__ABSTRACT);
		createEReference(concreteEntityEClass, CONCRETE_ENTITY__SUPER_ENTITY);
		createEReference(concreteEntityEClass, CONCRETE_ENTITY__ATTRIBUTES);
		...
		createEAttribute(attributeEClass, ATTRIBUTE__VOLATILE);
	...
	public void initializePackageContents() {
		...
		concreteEntityEClass.getESuperTypes().add(this.getEntity());
		...
		initEClass(packageEClass, com.gyaltso.ecore.model.entity.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Entities(), this.getEntity(), null, "entities", null, 0, -1, com.gyaltso.ecore.model.entity.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getConcreteEntity_Abstract(), ecorePackage.getEBoolean(), "abstract", null, 0, 1, ConcreteEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConcreteEntity_SuperEntity(), this.getEntity(), null, "superEntity", null, 0, 1, ConcreteEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConcreteEntity_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, ConcreteEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAttribute_Volatile(), ecorePackage.getEBoolean(), "volatile", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
