 ...
 * </p>
 * <ul>
 *   <li>{@link com.gyaltso.ecore.model.entity.impl.EnumerationImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationImpl extends EntityImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return EntityPackage.Literals.ENUMERATION;
	}
	...
	public EList<Literal> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<Literal>(Literal.class, this, EntityPackage.ENUMERATION__LITERALS);
		}
		return literals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EntityPackage.ENUMERATION__LITERALS:
